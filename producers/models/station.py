...
class Station(Producer):
    ...
    key_schema = avro.load(filelocation+"/schemas/arrival_key.json")
    value_schema = avro.load(filelocation+"/schemas/arrival_value.json")
    ...
    def __init__(self, station_id, name, color, direction_a=None, direction_b=None):
        ...
        topic_name = "org.chicago.cta.station.arrivals.v1" #Come up with a better topic name ##step3
